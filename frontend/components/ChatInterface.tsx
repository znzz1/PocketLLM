...
/**
 * ChatInterface Component with Stop Functionality
 *
 ...
 * - Supports stopping generation mid-stream
 *
 * Attributes:
...
export default function ChatInterface() {
  const { messages, sendMessage, stopGenerating, isLoading, clearMessages } = useChat()
          ...
          <div className="flex items-center gap-2">
            ...
            {isLoading && (
              <button
                ...
                className="flex-shrink-0 px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg text-sm font-medium transition-colors inline-flex items-center gap-2"
              >
